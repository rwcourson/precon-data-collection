    ...
    <div className="space-y-5">
      ...
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardDescription>
            Vertical one-estimate XLSX (Data Point / Input) or tabular CSV. Only
            Destini-checkmarked fields from the 2026 markup are written.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <DestiniImport />
      ...
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardDescription>
            Destini Data Validation sheet vs seeded dropdown lists. Gaps do not
            block import.
          </CardDescription>
        </CardHeader>
        <CardContent>
