/**
 * Pure formatters for mobile data surfaces (sheet grid, dashboards, schedule timeline).
 * Keep in sync with apps/mobile/src/lib/mobile-data-display.ts and iOS Formatters.sheetDisplayName.
 */
